	...
	public static void main(String[] args) {
		...
		Thread t1 = new Thread(()-> {
			...
			for(int i = 0; i<20; i++) {
				...
				try {
					Thread.sleep(100);// 스레드를 일시정지 시키는 메서드(ms)
