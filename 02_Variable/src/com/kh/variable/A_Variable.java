...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("문승주 : " + 8500 * 6 * 5);
		System.out.println("문승주1 : " + 8500 * 6 * 5);
		System.out.println("문승주2 : " + 8500 * 6 * 5);
		System.out.println("문승주3 : " + 8500 * 6 * 5);
		
		int pay = 8500; 
		int time = 6;
		int day = 5;
		
		System.out.println("문승주 : " + pay * time * day);
		System.out.println("문승주1 : " + pay * time * day);
		System.out.println("문승주2 : " + pay * time * day);
		System.out.println("문승주3 : " + pay * time * day);
	...
	public void declareVariable() {
		...
		double dNum; // 8byte 소수점 15자리까지 표현
	...
	public void constant () {
		...
		final int AGE = 21;
		//AGE =22;
		// 상수값을 저장하고있는 변수의 이름은 "대문자"로 작성한다.
		// USER_FIRSTNAME
	}
}