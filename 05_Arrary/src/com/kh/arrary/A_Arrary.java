package com.kh.arrary;

import java.util.Arrays;

public class A_Arrary {
	/*
	 * 변수 : 하나의 공간에 하나의 값을 저장할 수 잇는 저장공간.
	 * 	    int a = 10;
	 *      a = 20;
	 * 배열 : 하나의 공간에 여러개의 값을 담을 수 있다.("같은 자료형"기준)
	 *      ex) int[] a = new int[3];
	 *      int자료형 값을 담을 수 있는 저장공간이 3칸 할당된다.
	 *      [0, 0 , 0]
	...
	public void method2() {
		...
		System.out.println("Arr :" + iArr); //배열에 저장한 값이 아닌 주소값이 나열
		...
		System.out.println(iArr2 ==iArr3);
	}
	public void method3() {
		int [] iArr = new int[5];
	...
	public void method4() {
		...
		// 단, 참조변수가 null을 저장한 상태에서 주소값이 잇어야 수행할 수 있는 행위
		// 를 코드를 작성하면 실행시 에러가 발생한다.
	...
	public void method7() {
		...
		//Arrarys.toString(배열) => 배열내부의 값들을 문자열로 변환하여 반환하는 메서드.
